...
이 Repository는 RUBATO 웹페이지 개발 프로젝트의 Backend Legacy Repository입니다.
Contribute 하려는 Repo가 해당 Repo가 맞는지 확인을 꼭 해주시기 바랍니다.

## 1. Fork and Clone

모든 contribution은 fork한 레포를 통해 진행합니다.
그러므로 `cau-rubato/rubato-legacy-backend` 레포에서 개인 레포로 fork 해줍니다.
...
`cau-rubato/rubato-legacy-backend` 레포에 Pull Request를 PR Template에 맞게 작성 후 올립니다.
